...
def gj_Solve(A, b=False, decPts=4):
  """ Un método de Gauss-Jordan para resolver una matriz aumentada para
       las variables desconocidas, x, en Ax = b.
       El grado de redondeo se 'sintonizado' alterando decPts = 4.
       En el caso en que b no se suministra, b = matriz de ID, y por lo tanto
       la salida es la inversa de la matriz A.
  """
